...
class AclCog(commands.Cog):
    ...
    async def clear_rules(self, interaction: discord.Interaction):
        ...
        info(self, "Clearing rules", interaction.guild)
    ...
    async def admin_mode(self, interaction: discord.Interaction):
        ...
        info(self, "Toggling admin mode", interaction.guild)
        ...
        await respond(
            interaction, f"Admin mode has been toggled {'on' if admin_mode else 'off'}"
        )
